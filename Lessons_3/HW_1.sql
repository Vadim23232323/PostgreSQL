...
--FROM products
--WHERE discontinued = 0 and units_in_stock < ALL(SELECT  AVG (quantity)
--	FROM order_details
--	GROUP BY product_id
...
--USING(order_id)
--WHERE ship_country IN ('Argentina', 'Bolivia', 'Brazil', 'Chile', 'Colombia', 'Ecuador', 'Guyana', 'Paraguya', 'Peru', 'Suriname')
